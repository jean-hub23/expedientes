...
urlpatterns = [
    ...
    path('ui-elements/session-timeout', views.SessionTimeoutView.as_view(), name='ui-session-timeout'),
    # Session Timeout
    ...
    path('ui-elements/tabs&Accordions', views.TabsAccordionsView.as_view(), name='ui-tabs-accordions'),
    # Tabs & Accordions
    ...
    path('icons/materialdesign-icons', views.MaterialdesignIconsView.as_view(), name='icons-materialdesign'),
    # Icons-Materialdesign
    path('icons/dripicons-icons', views.DripiconsIconsView.as_view(), name='icons-dripicons'),  # Icons-Dripicons
    path('icons/fontawesome-icons', views.FontawesomeIconsView.as_view(), name='icons-fontawesome'),
    # Icons-Fontawesome
    # Maps
