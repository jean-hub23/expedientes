...
urlpatterns = [
    ...
    path('vertical/compact-sidebar', views.CompactSidebarView.as_view(), name="layouts-compact-sidebar"),
    # Compact Sidebar
    ...
    path('vertical/preloader-layout', views.PreloaderLayoutView.as_view(), name="layouts-preloader"),
    # Preloader Layout
    path('vertical/colored-sidebar', views.ColoredSidebarView.as_view(), name="layouts-colored-sidebar"),
    # Colored Sidebar
    # path('vertical/Vertical-Scrollable',views.VerticalScrollableView.as_view(),name="layouts-scrollable"),# Vertical Scrollable

    # Horizontal Layouts
    path('horizontal/horizontal-layout', views.HorizontalView.as_view(), name="layouts-horizontal"),
    # Horizontal Layout
    ...
    path('horizontal/horizontal-preloader-layout', views.HorizontalPreloaderLayoutView.as_view(),
         name="layouts-hori-preloader"),  # Preloader Layout
